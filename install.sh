...
#
#     curl -fsSL https://raw.githubusercontent.com/Vinax89/caelestia-dots-kde/main/install.sh | sh
#
#   Overridable via environment:
#     CAELESTIA_REPO    repository URL (default: Vinax89/caelestia-dots-kde)
...
REPO="${CAELESTIA_REPO:-https://github.com/Vinax89/caelestia-dots-kde.git}"
